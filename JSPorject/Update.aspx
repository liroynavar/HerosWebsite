...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.Form["sub"] != null)
        {
            ...
            cmdStr = string.Format("UPDATE UsersTable SET FirstName=N'{0}', LastName=N'{1}' , Email=N'{2}', Password=N'{3}' , Id=N'{4}', PhoneNumber=N'{5}', City=N'{6}', Street=N'{7}', HomeNumber=N'{8}' WHERE Username=N'{9}'", fName, lName, email, pass, id, phone, city, street, homeNum, Session["Login"]);
        ...
        cmdStr = string.Format("SELECT * FROM  UsersTable WHERE UserName = N'{0}'", Session["Login"]);
