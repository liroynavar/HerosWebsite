...
<asp:Content ID="Content2" ContentPlaceHolderID="imgBanner" runat="Server">
    <div class="bgded" style="height: 848px; background-image: url('images/ErrPics/ErrDoubleBanner.jpg');">
</asp:Content>
...
<asp:Content ID="Content10" ContentPlaceHolderID="sideImg" runat="Server">
    <p style="margin-top: 30px; float: right; font-size:80px;font-family: Times New Roman"> תפוס</p>
</asp:Content>
<asp:Content ID="Content11" ContentPlaceHolderID="superPowersHeadLine" runat="Server">
    <p style="margin-top: -26px; float: left; font-size:80px;font-family: Times New Roman">משתמש </p>
</asp:Content>
