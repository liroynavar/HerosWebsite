...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.Form["sub"] != null)
        {
            ...
            string section2 = Request.Form["section2"].ToString();
            string sectTxt2 = Request.Form["sectTxt2"].ToString();
            ...
            string cmdStr = string.Format("SELECT FirstName, LastName, UserName, Email, Password, Id, PhoneNumber, City, Street, HomeNumber, BirthDay, BirthMonth, BirthYear, Gender FROM UsersTable WHERE {0} = N'{1}' AND {2} = N'{3}'", section, sectTxt, section2 , sectTxt2 );
...
<asp:Content ID="Content3" ContentPlaceHolderID="heroName" runat="Server">
    <p style="margin-top: 30px; background-color: rgba(142,123,123,.63); width: 890px; float: right">הצגת משתמשים לפי שני חתכים</p>
</asp:Content>
...
<asp:Content ID="Content12" ContentPlaceHolderID="superPowersText" runat="Server">
    <form action="TwoSection.aspx" method="post">
        <select id="section" name="section">
            <option value="0" selected="1">בחר חתך ראשון</option>
        ...
        <select id="section2" name="section2">
            <option value="0" selected="1">בחר חתך שני</option>
            <option value="FirstName">שם פרטי</option>
            <option value="LastName">שם משפחה </option>
            <option value="City">עיר</option>
            <option value="Street">רחוב</option>
